...
export default class Practice20 extends LightningElement {
    ...
    // //wiring using the function
    // //the result will be assigned to method param//wire the result of apex method into function parameter
    // @wire(getMaxOppAmount)
    ...
    //the result will be assigned to property//wire the result of apex method into property
    // @wire(getMaxOppAmount)
    // highestOppAmount; 
