/*trigger AccountTrigger on Account( before insert, after insert,
  ...
  if (Trigger.isAfter && Trigger.isInsert) {
    System.debug('I am inside After Insert Code : ');
        ...
        // We are about to insert contacts for each Account entered
        // the trigger, so we need a List<Contact> to store it and 
        //eventually insert this using DML outside the loop 
        List <Contact> contactList = new List<Contact>();

    // Start with Trigger Loop because we get the records that 
    ...
    //You have prepaired your List, now m
    insert contactList ;
